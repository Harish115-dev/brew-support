...
export const Footer = () => {
  return (
          <footer className="w-full max-w-5xl mx-auto border-t border-[#e8dcc8] px-4 sm:px-6 pt-8 pb-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#b09a7a]">
